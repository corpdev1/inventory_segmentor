...
def abnormal_behavior(sleep_btwn_qrs):
    data = generate_data_det(50)
    modify_data_det(n=500, sleep_between_queries=sleep_btwn_qrs)
    delete_data_det(n=15, sleep_between_queries=sleep_btwn_qrs)
    insert_data_det(data, sleep_between_queries=sleep_btwn_qrs)
    time.sleep(0.02)
...
if __name__ == "__main__":
    ...
    normal_iter = int(normal_duration / 9.73)
    abnormal_iter = int(abnormal_duration / 2.54)
    sleep_normal = 0.5
    sleep_abnormal = 0.002
